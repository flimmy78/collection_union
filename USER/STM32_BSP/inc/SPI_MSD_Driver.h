...
#define CMD13					 13      //Send Status,»ñÈ¡SD¿¨×´Ì¬¡£

/* Physical level marcos */
#define _card_enable()      	GPIO_ResetBits(GPIOB,GPIO_Pin_12)
#define _card_disable()     	GPIO_SetBits(GPIOB,GPIO_Pin_12)
#define _card_power_on()
//#define _card_insert()        	//GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_2)

extern uint16 gSD_Err;
/* Private typedef -----------------------------------------------------------*/
enum _CD_HOLD
{
    HOLD = 0,
...
extern OS_EVENT *FlashMutex;
extern uint8 gu8SDStatus;
