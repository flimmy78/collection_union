...
#define TEMPGATHER_GUONENG		7	//威海国能户用温度采集装置用协议。
#define PANELWIRED_ELSONIC		8	//亿林有线面板标准协议。
#define VALVE_GUONENG			9	//威海国能温控阀用协议。
...
#define SETVALVE_OFFSETTEMP			12		//设置补偿温度。
#define SETVALVE_HYSTEMP			13		//设置阀控启动温差(滞回温度)
#define SETTEMP_GATHERPERIOD		14		//设置温控面板温度采集周期。
