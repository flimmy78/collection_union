...
INT32S main(void)
{
    ...
    os_err = OSTaskCreateExt((void(*)(void *))App_TaskStart,  /* Create the start
    task.                               */
                             (void *)0, (OS_STK *) &App_TaskStartStk[APP_TASK_START_STK_SIZE - 1], (INT8U)
                             APP_TASK_START_PRIO, (INT16U)APP_TASK_START_PRIO, (OS_STK *)
                             &App_TaskStartStk[0], (INT32U)APP_TASK_START_STK_SIZE, (void *)0, (INT16U)
...
static void App_TaskStart(void *p_arg)
{
    ...
    */
    ...
    Uart_Printf("\r\n===============================================");
    Uart_Printf("\r\n=         (C) COPYRIGHT 2015 Aerospace Delu");
    Uart_Printf("\r\n=                                      ");
    Uart_Printf("\r\n=           app (Version %d.%d%d)          ", (gVersion >> 8)
                & 0x0f, (gVersion >> 4) & 0x0f, gVersion & 0x0f);
    Uart_Printf("\r\n=                                      ");
    Uart_Printf("\r\n=        By 513 Aerospace Application Team ");
    Uart_Printf("\r\n===============================================");
